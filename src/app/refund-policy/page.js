      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 pt-12">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-12">
            Due to the nature of research chemicals, all sales are final under
            most circumstances. However, we stand behind our products.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-xs font-bold tracking-[0.15em] uppercase text-black">
                Eligible for Refund
              </h2>
            </div>
